...
const isSimulation = process.argv.length === 3 && process.argv[2] === "functions-simulate-script"

// Set EVM private keys (required)
const PRIVATE_KEY = process.env.PRIVATE_KEY || "0x1234567812345678123456781234567812345678123456781234567812345678";

// TODO @dev - set this to run the accept.js task.
const SECOND_PRIVATE_KEY = process.env.SECOND_PRIVATE_KEY || "0x1234567812345678123456781234567812345678123456781234567812345678";
